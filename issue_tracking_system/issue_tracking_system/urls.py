...
router.register('project/<int:id>/update_issue/<int:id>', projects.views.CreateIssueViewSet,
...
router.register('project/<int:id>/delete_issue/<int:id>/create_comment', projects.views.CreateCommentViewSet,
                basename='delete_issue/<int:id>/create_comment')
